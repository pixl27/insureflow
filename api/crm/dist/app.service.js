...
let AppService = class AppService {
    ...
    async createTask(customerId, data) {
        await this.ensureCustomerExists(customerId);
    ...
    async createInteraction(customerId, data) {
        await this.ensureCustomerExists(customerId);
    ...
    async updateCustomer(id, data) {
        ...
        if (kycStatus)
            customerUpdate.kycStatus = kycStatus;
        if (score !== undefined)
            customerUpdate.score = score;
        let firstName = '';
        let lastName = name || '';
    ...
    async mergeCustomers(primaryId, duplicateId) {
